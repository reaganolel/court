      ...
      <div class="mainArea-first col-xs-12 col-md-7 col-lg-8"> 
       ...
       <div class="panel panel-default"> 
        ...
        <!--  <div class="col-xs-12 col-sm-4 col-md-6 col-lg-4"> 
           <div class="phone"> 
            <i class="clicable fa fa-phone"></i> 
           </div> 
          </div> 
-->
         ...
         <div class="hidden-md hidden-lg"> 
          <div class="col-xs-12"> 
           <a href="#"> <h1>Customary Court</h1> </a> 
          </div> 
         ...
         <!-- <div class="col-xs-12 col-sm-4"> 
           <div class="phone"> 
            <a style="color: inherit;" href="tel:"><i class="clicable fa fa-phone"></i>9642256631</a> 
           </div> 
          </div> 
-->
        ...
        <div class="row court-info" data-court-id="23"> 
         ...
         <a class="hidden-xs hidden-sm" href="#"> 
          <div class="col-xs-12"> 
           <h1>National Industrial Court</h1> 
          </div> 
          <div class="address col-xs-12 col-sm-8 col-md-6 col-lg-8">
...
-->
         ...
         <div class="hidden-md hidden-lg"> 
          <div class="col-xs-12"> 
           <a href="#"> <h1>National Industrial Court </h1> </a> 
          </div> 
          <div class="address col-xs-12 col-sm-8">
           National Industrial Court of Kenya
          </div> 
         <!-- <div class="col-xs-12 col-sm-4"> 
           <div class="phone"> 
            <a style="color: inherit;" href="tel:"><i class="clicable fa fa-phone"></i>615206667</a> 
           </div> 
          </div> 
-->
          <a class="court-info-link" href="#"> <i class="fa fa-angle-right"></i> </a> 
...
-->
         ...
         <div class="hidden-md hidden-lg"> 
          <div class="col-xs-12"> 
           <a href="#"> <h1>Supreme High Court</h1> </a> 
          </div> 
          <div class="address col-xs-12 col-sm-8">
            No 1, Supreme Court Kenya 
          </div> 
         <!-- <div class="col-xs-12 col-sm-4"> 
           <div class="phone"> 
            <a style="color: inherit;" href="tel:"><i class="clicable fa fa-phone"></i>01234567</a> 
           </div> 
          </div> 
-->
          <a class="court-info-link" href="#"> <i class="fa fa-angle-right"></i> </a> 
...
-->
         ...
         <div class="hidden-md hidden-lg"> 
          <div class="col-xs-12"> 
           <a href="#"> <h1>Federal High Court</h1> </a> 
          </div> 
          <div class="address col-xs-12 col-sm-8">
            No 1,  HighCourt Kenya
          </div> 
          <div class="col-xs-12 col-sm-4"> 
           <div class="phone"> 
            <a style="color: inherit;" href="tel:"><i class="clicable fa fa-phone"></i>0729287906</a> 
           </div> 
          </div> 
...
-->
         ...
         <div class="hidden-md hidden-lg"> 
          <div class="col-xs-12"> 
           <a href="#"> <h1>State High Court</h1> </a> 
          </div> 
          <div class="address col-xs-12 col-sm-8">
            No 1, Court Kenya 
          </div> 
         <!-- <div class="col-xs-12 col-sm-4"> 
           <div class="phone"> 
            <a style="color: inherit;" href="tel:"><i class="clicable fa fa-phone"></i>012345678</a> 
           </div> 
          </div> 
-->
          <a class="court-info-link" href="#"> <i class="fa fa-angle-right"></i> </a> 
